...
module.exports = function getClaims(provider) {
  ...
  return class Claims {
    ...
    async result() {
      ...
      console.log(`claims result will work with: ${JSON.stringify(available)}`)
